...
* Release Team Leads
  * Release Lead: [@drewhagen](https://github.com/drewhagen)
  * Release Lead Shadow: (at)USERNAME
  * Release Lead Shadow: (at)USERNAME
  * Release Lead Shadow: (at)USERNAME
  * Release Lead Shadow: (at)USERNAME
* Release Cycle: `Kubernetes 1.35`
* [Release Timeline](https://github.com/kubernetes/sig-release/tree/master/releases/release-1.35) <!-- DON'T FORGET TO UPDATE THE LINK -->
...
- [ ] Release directory named `release-1.35` added to [k/sig-release/releases](https://github.com/kubernetes/sig-release/tree/master/releases)
...
- [ ] Updated `kubernetes/sig-release` `OWNERS`
  - Release Team Lead and Shadows
    - Add an `approvers` entry in `releases/release-1.35/OWNERS`
...
#### After Code Freeze
- [ ] Verified that the [`release-1.35` branch](https://github.com/kubernetes/kubernetes/branches) has been automatically created at the start of Test Freeze
...
- [ ] Completed release theme (slogan, logo and explanation text) and add it to the [release cycle documentation in k/sig-release/releases/release-1.35](https://github.com/kubernetes/sig-release/tree/master/releases)
